...
class SwaggerConfigControllerTest {
    ...
    void shouldGenerateSwaggerConfigJson() {
        ...
        assertThat(result.getResponseBody()).isEqualTo("{\"urls\":[{\"url\":\"//customer-orchestration/v3/api-docs\",\"name\":\"customer-orchestration\"},{\"url\":\"//customer-entity/v3/api-docs\",\"name\":\"customer-entity\"}]}");
    }
}